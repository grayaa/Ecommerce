...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'montanttva_extension' => 'getMontanttvaExtensionService',
            ...
            'tva_extension' => 'getTvaExtensionService',
            'twig' => 'getTwigService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('weTQ6qkw-Q', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('18QDugD57Q', 0, 'QD0Ra9HCClQ2Qqm84BhBRa', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a2754a84cd26de373e0c894d2d186505c05f6b630b488efbf6446fc5acf74e2c');
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager(${($_ = isset($this->services['fos_user.util.password_updater']) ? $this->services['fos_user.util.password_updater'] : $this->getFosUser_Util_PasswordUpdaterService()) && false ?: '_'}, ${($_ = isset($this->services['fos_user.util.canonical_fields_updater']) ? $this->services['fos_user.util.canonical_fields_updater'] : $this->getFosUser_Util_CanonicalFieldsUpdaterService()) && false ?: '_'}, $this->get('doctrine')->getManager(NULL), 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs');
    }
    ...
    /**
     * Gets the 'montanttva_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getMontanttvaExtensionService()
    {
        return $this->services['montanttva_extension'] = new \Ecommerce\EcommerceBundle\Twig\Extension\MontantTvaExtension();
    }
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('E7BHX3R+DE', NULL, 'QD0Ra9HCClQ2Qqm84BhBRa', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    /**
     * Gets the 'tva_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getTvaExtensionService()
    {
        return $this->services['tva_extension'] = new \Ecommerce\EcommerceBundle\Twig\Extension\TvaExtension();
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('tva_extension'));
        $instance->addExtension($this->get('montanttva_extension'));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('3e44fc7b6945c3f19c231bdb361ecc5cccf3d187');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1HkjHsMrCY', 0, 'QD0Ra9HCClQ2Qqm84BhBRa', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '3e44fc7b6945c3f19c231bdb361ecc5cccf3d187',
            'locale' => 'fr',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '3e44fc7b6945c3f19c231bdb361ecc5cccf3d187',
